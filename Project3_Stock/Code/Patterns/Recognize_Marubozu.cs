...
{
    class Recognize_Marubozu : Recognizer
    {
        public Recognize_Marubozu() : base("Marubozu", 1)
        {
            // Inherited Constructor to initialize patternName and patternLength
        }

        // Overrides abstract method for Marubozu pattern recognition.
        public override bool Recognize(BindingList<SmartCandleStick> smartCandleSticks, int index)
        {
            ...
            bool result = (scs.TopPrice >= scs.High) && (scs.BottomPrice <= scs.Low);
